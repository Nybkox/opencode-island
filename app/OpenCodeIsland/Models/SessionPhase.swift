...
//  OpenCodeIsland
//
//  Explicit state machine for OpenCode session lifecycle.
...
enum SessionPhase: Sendable {
    ...
    /// OpenCode is actively processing (running tools, generating response)
    case processing

    /// OpenCode has finished and is waiting for user input
    ...
    nonisolated func canTransition(to next: SessionPhase) -> Bool {
        ...
        case (.waitingForApproval, .waitingForInput):
            return true  // Denied and OpenCode stopped
