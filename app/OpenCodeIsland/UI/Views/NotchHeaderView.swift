...
struct OpenCodeCrabIcon: View {
    ...
    init(size: CGFloat = 16, color: Color = TerminalColors.slate300, animateLegs: Bool = false) {
        self.size = size
        self.color = color
...
struct PermissionIndicatorIcon: View {
    ...
    init(size: CGFloat = 14, color: Color = TerminalColors.slate400) {
        self.size = size
        self.color = color
    }
