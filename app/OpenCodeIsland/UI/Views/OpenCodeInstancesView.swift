...
struct OpenCodeInstancesView: View {
    @ObservedObject var sessionMonitor: OpenCodeSessionMonitor
...
struct InstanceRow: View {
    ...
    private let spinnerColor = TerminalColors.slate300
        ...
        HStack(alignment: .center, spacing: 10) {
            ...
            if isWaitingForApproval && isInteractiveTool {
                ...
                HStack(spacing: 8) {
                    ...
                    // Chat icon - always show, always rightmost
                    IconButton(icon: "bubble.left") {
                        onChat()
                    }
                }
    ...
    var body: some View {
        HStack(spacing: 6) {
            ...
            Button {
                ...
                Text("Deny")
                    .font(.system(size: 11, weight: .medium))
                    .foregroundColor(TerminalColors.slate300)
                    .padding(.horizontal, 10)
                    .padding(.vertical, 5)
                    .background(TerminalColors.slate600)
                    .clipShape(Capsule())
            }
            .buttonStyle(.plain)
    ...
    var body: some View {
        Button {
            ...
            Image(systemName: icon)
                .font(.system(size: 11, weight: .medium))
                .foregroundColor(isHovered ? TerminalColors.iconHover : TerminalColors.icon)
...
struct TerminalButton: View {
    ...
    var body: some View {
        Button {
            ...
            .foregroundColor(isEnabled ? .black : TerminalColors.textMuted)
            .padding(.horizontal, 10)
            .padding(.vertical, 5)
            .background(isEnabled ? TerminalColors.slate200 : TerminalColors.slate600)
            .clipShape(Capsule())
        }
        .buttonStyle(.plain)
    }
