...
//  OpenCodeIsland
//
//  Handles OpenCode tool approval operations via tmux
//

import Foundation
import os.log

/// Handles tool approval and rejection for OpenCode instances
actor ToolApprovalHandler {
    ...
    nonisolated static let logger = Logger(subsystem: "com.opencodeisland", category: "Approval")
