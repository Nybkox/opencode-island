...
class AppDelegate: NSObject, NSApplicationDelegate {
    ...
    func applicationDidFinishLaunching(_ notification: Notification) {
        ...
        fetchAndRegisterOpenCodeVersion()
    ...
    private func fetchAndRegisterOpenCodeVersion() {
        let openCodeProjectsDir = FileManager.default.homeDirectoryForCurrentUser
            .appendingPathComponent(".opencode/projects")

        guard let projectDirs = try? FileManager.default.contentsOfDirectory(
            at: openCodeProjectsDir,
        ...
        for line in content.components(separatedBy: .newlines) where !line.isEmpty {
            ...
            Mixpanel.mainInstance().registerSuperProperties(["opencode_version": version])
            Mixpanel.mainInstance().people.set(properties: ["opencode_version": version])
            return
        }
    }

    private func ensureSingleInstance() -> Bool {
        let bundleID = Bundle.main.bundleIdentifier ?? "com.nybkox.OpenCodeIsland"
